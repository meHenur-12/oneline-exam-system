...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2018 at 02:50 AM
...
INSERT INTO `mst_admin` (`id`, `visible`, `loginid`, `pass`) VALUES
(1, 1, 'harun', '12345'),
(28, 1, 'admin', 'admin');
...
(46, 'a190kvpr4hpne7gs7lvgep5rc4', 3, 'What does PHP stand for?', 'Personal Hypertext Processor', 'PHP: Hypertext Preprocessor', 'Private Home Page', 'Public Home Page', 2, 2),
(47, 'a190kvpr4hpne7gs7lvgep5rc4', 3, 'PHP server scripts are surrounded by delimiters, which?', '&lt?php ?&gt', '&lt?php &gt &lt?&gt', '&lt &amp &gt', '&lt?script&gt', 1, 1),
(48, 'a190kvpr4hpne7gs7lvgep5rc4', 3, 'How do you write "Hello World" in PHP', 'echo "Hello World";', '"Hello World";', 'Document.Write("Hello World");', 'printf "Hello World";', 1, 1),
(55, 'g4is3pvejr48hn7q9pd0oqa7s7', 3, 'What does PHP stand for?', 'Personal Hypertext Processor', 'PHP: Hypertext Preprocessor', 'Private Home Page', 'Public Home Page', 2, 1),
(56, 'g4is3pvejr48hn7q9pd0oqa7s7', 3, 'PHP server scripts are surrounded by delimiters, which?', '&lt?php ?&gt', '&lt?php &gt &lt?&gt', '&lt &amp &gt', '&lt?script&gt', 1, 1),
(57, 'g4is3pvejr48hn7q9pd0oqa7s7', 3, 'How do you write "Hello World" in PHP', 'echo "Hello World";', '"Hello World";', 'Document.Write("Hello World");', 'printf "Hello World";', 1, 1);
...
(2, 'suman gangopadhay', 'suman', 'suman123@gmail.com', '01776967480', 'suman', 1);
